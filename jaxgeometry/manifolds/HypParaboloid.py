...
class HypParaboloid(riemannian.EmbeddedManifold):
    ...
    def plotx(self, x, u=None, v=None, N_vec=np.arange(0,n_steps), i0=0, color='b', color_intensity=1., linewidth=1., s=15., prevx=None, last=True):
        if len(x.shape)>1:

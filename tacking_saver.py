...
from geometry.tacking import SequentialOptimizationADAMSaver
...
def estimate_tacking()->None:
    ...
    Tacking = SequentialOptimizationADAMSaver(tack_metrics, lr_rate=args.lr_rate, init_fun=None, max_iter=args.max_iter, 
                                     tol=args.tol, T=args.T, sub_iter=args.sub_iter, line_search_params={'rho': 0.5})
    ReverseTacking = SequentialOptimizationADAMSaver(reverse_tack_metrics, lr_rate = args.lr_rate, init_fun = None, max_iter=args.max_iter, tol=args.tol,

...
class Bisection(ABC):
    ...
    def update_alpha(self,
        ...
        obj0 = self.obj_fun(self.t, self.update_fun(self.x, alpha0, *_))
        obj1 = self.obj_fun(self.t, self.update_fun(self.x, alpha1, *_))
    ...
    def __call__(self, 
        ...
        self.t = t
        self.x = x
        obj0 = self.obj_fun(self.t, self.x, self.alpha_min, *args)
        obj1 = self.obj_fun(self.t, self.update_fun(self.x, self.alpha_max, *args))
